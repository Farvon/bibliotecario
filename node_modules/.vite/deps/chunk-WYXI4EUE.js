...
var FormControl = React4.forwardRef(function FormControl2(props, forwardedRef) {
  var _slots$root;
  const {
    defaultValue,
    children,
  ...
  React4.useEffect(() => setFocused((isFocused) => disabled ? false : isFocused), [disabled]);
  ...
  return (0, import_jsx_runtime2.jsx)(FormControlContext.Provider, {
    value: childContext,
...
function useFormControlContext() {
  return React5.useContext(FormControlContext);
}
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React6.useState(value ? String(value) : void 0);
  React6.useEffect(() => {
...
var _excluded3 = ["className", "defaultValue", "disabled", "error", "id", "max", "min", "onBlur", "onInputChange", "onFocus", "onChange", "placeholder", "required", "readOnly", "shiftMultiplier", "step", "value", "slotProps", "slots"];
...
var NumberInput = React7.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime4.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime3.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime3.jsx)(IncrementButton, _extends({}, incrementButtonProps)), (0, import_jsx_runtime3.jsx)(Input, _extends({}, inputProps))]
  }));
});
...
//# sourceMappingURL=chunk-WYXI4EUE.js.map
