import {
  useTheme
} from "./chunk-67FNU7BS.js";
import {
  Transition_default
} from "./chunk-HIFPMJBU.js";
import {
  require_react_dom
...
import {
  init_useForkRef,
  useForkRef_default
} from "./chunk-BEBE5C2F.js";
import {
  init_composeClasses
} from "./chunk-4V6ZBVLA.js";
import {
  HTMLElementType,
  _extends,
...
function useSnackbar(parameters = {}) {
  ...
  const timerAutoHide = React4.useRef();
  React4.useEffect(() => {
    if (!open) {
      return void 0;
    }
  ...
  const handleResume = React4.useCallback(() => {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime28.jsx)(React49.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TM67IM3V.js.map
