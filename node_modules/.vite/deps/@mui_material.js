...
var _excluded57 = ["actions", "children", "defaultValue", "name", "onChange", "value"];
...
function RatingItem(props) {
  ...
  return (0, import_jsx_runtime94.jsxs)(React85.Fragment, {
...
function SliderValueLabel(props) {
  ...
  }, (0, import_jsx_runtime98.jsxs)(React88.Fragment, {
...
var _excluded61 = ["aria-label", "aria-valuetext", "aria-labelledby", "component", "components", "componentsProps", "color", "classes", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "size", "step", "scale", "slotProps", "slots", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat"];
function Identity(x) {
  return x;
}
...
var Snackbar = React91.forwardRef(function Snackbar2(inProps, ref) {
  ...
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded63), other = _objectWithoutPropertiesLoose(props, _excluded214);
  const ownerState = _extends({}, props, {
    anchorOrigin: {
      vertical,
      horizontal
...
var SpeedDial = React93.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  const {
    ...
    transitionDuration = defaultTransitionDuration,
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded65), other = _objectWithoutPropertiesLoose(props, _excluded215);
  ...
  const eventTimer = React93.useRef();
  React93.useEffect(() => {
    return () => {
